...
import { Grid, ButtonGroup, Button, FormControl, InputLabel, TextField, Typography, Box, styled } from '@mui/material';
...
const FormOpcional = ({ onClose }) => {
  ...
  <Grid container direction="column" alignItems="center">
    ...
    <Grid item>
      <ButtonGroup variant="contained" fullWidth aria-labelledby="objetivo-label" style={{ marginTop: '8px' }}>
