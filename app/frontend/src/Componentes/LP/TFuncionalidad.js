    ...
    <div>
      <Accordion expanded={expanded === 'panel1'} onChange={handleChange('panel1')}>
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
          <Typography sx={{ fontFamily: 'Poppins' }} variant="h6">RECETAS IDEALES</Typography>
        </AccordionSummary>
        <AccordionDetails>
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')}>
        <AccordionSummary aria-controls="panel2d-content" id="panel2d-header">
          <Typography sx={{ fontFamily: 'Poppins' }} variant="h6">FILTRAR RECETAS</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography sx={{fontSize:'18px', fontFamily: 'Poppins' }}>
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')}>
        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
          <Typography sx={{ fontFamily: 'Poppins' }} variant="h6">BUSCAR RECETAS</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography sx={{fontSize:'18px', fontFamily: 'Poppins' }}>
      ...
      <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')}>
        <AccordionSummary aria-controls="panel4d-content" id="panel4d-header">
          <Typography sx={{ fontFamily: 'Poppins' }} variant="h6">MARCAR RECETAS FAVORITAS</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography sx={{fontSize:'18px', fontFamily: 'Poppins' }}>
      ...
      <Accordion expanded={expanded === 'panel5'} onChange={handleChange('panel5')}>
        <AccordionSummary aria-controls="panel5d-content" id="panel5d-header">
          <Typography sx={{ fontFamily: 'Poppins' }} variant="h6">AÑADIR RECETAS</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography sx={{fontSize:'18px', fontFamily: 'Poppins' }}>
      ...
      <Accordion expanded={expanded === 'panel6'} onChange={handleChange('panel6')}>
        <AccordionSummary aria-controls="panel6d-content" id="panel6d-header">
          <Typography sx={{ fontFamily: 'Poppins' }} variant="h6">GENERAR LISTA DE INGREDIENTES</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography sx={{fontSize:'18px', fontFamily: 'Poppins' }} >
