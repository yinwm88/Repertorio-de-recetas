...
insert into Ingrediente(nombre, unidad, caduca, calorias) values ('Salsa de soya', 'ml', true, 60);
...
insert into Receta(nombre, proceso) values ('Salsa marrón','Corta y saltea la cebolla y ponla a un lado. Luego, derrite la mantequilla en una sartén y añade la harina, cocinándola hasta que adquiera un color marrón oscuro a fuego medio. Agrega el caldo de carne en pequeñas cantidades mientras revuelves con una cuchara. Deja hervir la salsa hasta que espese. Finalmente, incorpora las cebollas salteadas y sazona con pimienta negra al gusto. Esta salsa puede servirse como está o con carne, según la preferencia.');
